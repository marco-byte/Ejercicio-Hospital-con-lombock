...
@Getter // Genera getters para los campos que no tienen uno manual
@ToString(of = {"nombre", "direccion", "telefono"}) // Genera un toString conciso
@EqualsAndHashCode(of = "nombre") // La igualdad se basa en el nombre del hospital
