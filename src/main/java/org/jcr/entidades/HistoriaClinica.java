...
@Getter // Genera los getters para numeroHistoria, paciente y fechaCreacion
@EqualsAndHashCode(of = "numeroHistoria") // Define la igualdad basada en el número de historia, que es único
public class HistoriaClinica implements Serializable {
    ...
    // Los getters para numeroHistoria, paciente y fechaCreacion son generados por @Getter
